      ...
      <div class="container mb-3">
        ...
        <div class="d-flex justify-content-between">
          <div>
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <h5>
                    <a class="nav-link active" aria-current="page" href="/admin-tabel-resep">Resep</a>
                  </h5>
              </li>
              <li>
                <h5>
                  <a class="nav-link" href="/admin-tabel-video">Video</a>
                </h5>
              </li>
            </ul>
          </div>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            $options = array(
                CURLOPT_URL => 'https://asia-south1.gcp.data.mongodb-api.com/app/application-0-aeujc/endpoint/getAllResep',
            ...
            foreach ($data as $row) :
              ...
              <td>' . (empty($row->resep) ? '' : $row->resep) . '</td>
