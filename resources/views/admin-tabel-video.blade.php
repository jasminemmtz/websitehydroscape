      ...
      <div class="container mb-3">
        ...
        <div class="d-flex justify-content-between">
          <div>
              <ul class="nav nav-tabs">
                <li class="nav-item">
                  <h5>
                    <a class="nav-link" href="admin-tabel-resep.php">Resep</a>
                  </h5>
              </li>
              <li>
                <h5>
                  <a class="nav-link active" aria-current="page" href="admin-tabel-video.php">Video</a>
                </h5>
              </li>
            </ul>
          </div>
          <div>
            <a href="javascript:void(0);" class="btn btn-primary btn-m rounded-pill" id="add">Tambah Produk</a>
          </div>
        </div>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            $options = array(
                CURLOPT_URL => 'https://asia-south1.gcp.data.mongodb-api.com/app/application-0-nuzti/endpoint/getAllDosen',
            ...
            foreach ($data as $row) :
              ...
              <a href= "admin-delete.php?id='.$row->_id.'" class="btn btn-danger btn-sm"
                      onclick="return confirm(\'Apkah Anda Yakin Akan Menghapus?\')">Hapus</a>
              </td>
