...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-sayur/Bayam Hijau.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
                <h2 style="font-weight: bold;">Bayam Hijau</h2>
                ...
                <div class="mt-3">
                    ...
                    <ol class="text-muted pl-1">
                        <li><i class="fas fa-check"></i> Pertama-tama, sortir bayam yang masih segar. Kemudian, bungkus bayam dengan tisu dan letakkan dalam wadah yang dapat ditutup rapat.</li>
                        <li><i class="fas fa-check"></i> Pastikan bayam dalam keadaan kering sebelum Anda memasukkannya ke dalam kulkas untuk penyimpanan yang dapat mencapai 7-10 hari.</li>
                    </ol>
                </div>
            </div>
        </div>
