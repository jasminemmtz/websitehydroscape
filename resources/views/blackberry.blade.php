<html lang="en">
  <head>
    ...
    <title>Blackberry All Seasons</title>
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-buah/Blackberry All Seasons.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
            <h2 style="font-weight: bold;">Blackberry All Seasons</h2>
            <p class="mb-1">Harga: Rp 36.500,-</p>
            <p class="mb-1">15 - 25 pcs/pack</p>
            <p class="mb-1">Lama Tahannya: 2-3 hari</p>
                ...
                <div class="product-description">
                    ...
                    <p class="text-justify">
                        Blackberry adalah buah dengan ukuran yang kompak dan memiliki kombinasi rasa asam dan manis yang menyegarkan. Keistimewaan blackberry adalah bahwa mereka ditanam dengan metode hidroponik, yang memastikan kualitas dan cita rasa terbaik dalam buah ini. Metode pertanian ini membantu menghasilkan blackberry yang lebih segar dan lezat, membuatnya menjadi pilihan yang istimewa bagi pecinta buah-buahan.
                    </p>
                </div>
                <div class="mt-3">
                    <h4 class="text-dark">Petunjuk Penyimpanan</h4>
                    <ol class="text-muted pl-1">
                        <li><i class="fas fa-check"></i> Bersihkan blackberry dengan mencucinya secara teliti</li>
                        <li><i class="fas fa-check"></i> Tempatkan blackberry dalam wadah yang rapat</li>
                        <li><i class="fas fa-check"></i> Simpan blackberry di dalam lemari es</li>
                      </ol>
                </div>
            </div>
        </div>
