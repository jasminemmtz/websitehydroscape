...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-sayur/Cabai Merah Besar.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
                <h2 style="font-weight: bold;">Cabai Merah Besar</h2>
                <p class="mb-1">Harga: Rp 19.300,-</p>
                <p class="mb-1">250 gram</p>
                <p class="mb-1">Lama Tahannya: 5 hari</p>
                ...
                <div class="product-description mt-3">
                    ...
                    Cabai merah yang ditanam menggunakan metode hidroponik adalah varietas besar dengan kulit yang berkilauan, memiliki tingkat kepedasan yang lebih rendah dibandingkan dengan cabai biasa. Varietas ini serbaguna dalam penggunaannya, dapat digunakan sebagai hiasan makanan, pewarna alami, penambah rasa pedas pada hidangan, dan tambahan pada berbagai jenis makanan. Namun, perlu diingat bahwa terdapat potensi variasi dalam gramasi produk ini, dengan kelebihan atau kekurangan sekitar 10% dari jumlah yang dijanjikan per kemasan.
                    </p>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <ol class="text-muted pl-1">
                        <li><i class="fas fa-check"></i> Singkirkan batang cabai</li>
                        <li><i class="fas fa-check"></i> Letakkan cabai dalam wadah yang telah dilapisi dengan tisu atau kertas</li>
                        <li><i class="fas fa-check"></i> Simpan dalam kulkas untuk menjaga kesegarannya dalam waktu yang lebih lama</li>
                        <li><i class="fas fa-check"></i> Simpan wadah dengan daun ketumbar di dalam kulkas</li>
                    </ol>
                </div>
            </div>
        </div>
