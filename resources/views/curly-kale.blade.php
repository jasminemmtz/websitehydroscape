...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-sayur/Curly Kale.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
                <h2 style="font-weight: bold;">Curly Kale</h2>
                <p class="mb-1">Harga: Rp 12.900,-</p>
                ...
                <div class="product-description mt-3">
                    ...
                    Curly Kale adalah jenis kale yang memiliki daun hijau dengan tekstur keriting yang khas.
                    Biasanya, kale ini dimasak sebagai tumisan atau digunakan dalam berbagai resep masakan lainnya. Pertumbuhannya menggunakan metode hidroponik, yang memastikan produk yang dihasilkan tetap segar dan lebih sehat. Setiap kemasan Curly Kale memiliki potensi variasi gramasi sekitar +-10%, memberikan fleksibilitas dalam penggunaan dan penyajian. Dengan memilih Curly Kale, Anda dapat menikmati kemudahan dalam memasak sambil tetap menjaga kualitas dan kebersihan makanan Anda, menjadikannya pilihan yang ideal untuk memperkaya menu Anda.
                    </p>
                </div>
