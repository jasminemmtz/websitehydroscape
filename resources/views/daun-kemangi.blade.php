...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-sayur/Daun Kemangi.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
                <h2 style="font-weight: bold;">Daun Kemangi</h2>
                <p class="mb-1">Harga: Rp 14.200,-</p>
                ...
                <div class="product-description mt-3">
                    ...
                    <p class="text-justify text-muted">
                        Kemangi hidroponik adalah varietas daun kemangi yang ditanam dengan metode hidroponik, sehingga menghasilkan kemangi yang lebih segar, sehat, dan berkualitas tinggi. Daun kemangi ini biasanya disajikan sebagai lalapan, dengan aroma khas yang segar dan menambah kenikmatan hidangan. Kombinasi kemangi dengan hidangan seperti ayam atau ikan goreng menciptakan paduan rasa yang lezat dan menyehatkan.
                    </p>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <ol class="text-muted pl-1">
                        <li><i class="fas fa-check"></i> Bungkus daun kemangi menggunakan kertas atau tisu </li>
                        <li><i class="fas fa-check"></i>  Letakkan dalam sebuah kontainer yang dapat ditutup rapat</li>
                        <li><i class="fas fa-check"></i> Simpan di dalam chiller atau kulkas untuk penyimpanan yang baik.</li>
                    </ol>
                </div>
            </div>
        </div>
