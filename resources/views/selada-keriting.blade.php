...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-sayur/Selada Keriting.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
                <h2 style="font-weight: bold;">Selada Keriting</h2>
                <p class="mb-1">Harga: Rp 17.800,-</p>
                ...
                <div class="product-description mt-3">
                    ...
                    Selada keriting hidroponik merupakan jenis selada yang tumbuh dengan metode hidroponik, menjadikannya bebas dari zat kimia tambahan dan pestisida. Dengan kualitas yang segar dan sehat, selada ini memiliki tekstur yang renyah dan gurih, serta memberikan sensasi segar saat dimakan. Biasanya digunakan sebagai isian sandwich, lalapan, atau dalam hidangan salad, selada ini juga memberikan potensi variasi dalam gramasi sekitar +-10% per pack, menawarkan fleksibilitas dalam penggunaan. Dengan selada keriting hidroponik, Anda dapat menikmati makanan yang lebih berkualitas dan sehat, serta berkontribusi pada lingkungan yang lebih bersahabat.
                    </p>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <ol class="text-muted pl-1">
                        ...
                        <li><i class="fas fa-check"></i> Tidak perlu mencuci selada yang akan disimpan</li>
                        <li><i class="fas fa-check"></i> Selada dapat dibungkus menggunakan kertas atau tisu</li>
