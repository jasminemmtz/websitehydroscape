...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-sayur/Selada Romaine.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
                <h2 style="font-weight: bold;">Selada Romaine</h2>
                <p class="mb-1">Harga: Rp 19.900,-</p>
                ...
                <div class="product-description mt-3">
                    ...
                    Selada romaine hidroponik yang kami tawarkan adalah varietas terbaik, ditanam melalui metode hidroponik yang memastikan kualitas tertinggi dalam hal kebersihan, kelezatan, dan gizi. Daun selada romaine ini memiliki kemiripan dengan sawi dalam penampilan dengan rasa yang manis dan tekstur yang renyah, menjadikannya pilihan ideal untuk berbagai jenis hidangan seperti salad, tumis, capcay, tumis selada, cah selada, dan beragam kreasi masakan lainnya. Dalam setiap kemasannya, terdapat potensi variasi dalam gramasi sekitar +-10%, memberikan fleksibilitas dalam memasak dan menyajikan hidangan Anda sesuai selera.
                    </p>
                </div>
