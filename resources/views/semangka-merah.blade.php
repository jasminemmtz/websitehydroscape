...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-buah/Semangka Merah.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
                <h2 style="font-weight: bold;">Semangka Merah</h2>
                <p class="mb-1">Harga: Rp 36.900,-</p>
                <p class="mb-1">3 - 3.5 kg/pcs</p>
                <p class="mb-1">Lama Tahannya: 2-3 hari</p>
                ...
                <div class="product-description">
                    ...
                    <p class="text-justify">
                        Semangka merah memiliki citarasa yang manis, menyegarkan, dan tinggi kandungan airnya, menjadikannya pilihan yang ideal untuk dimakan langsung, diolah menjadi jus segar, dicampurkan dalam sop buah, atau digunakan dalam berbagai kreasi kuliner lainnya. Perlu diperhatikan bahwa terdapat potensi variasi dalam berat semangka merah dalam kisaran sekitar 10% lebih atau kurang dari kemasan yang diberikan, sehingga perlu memperhitungkan variasi tersebut dalam penggunaan dan penyajian makanan.
                    </p>
                </div>
                <div class="mt-3">
                    <h4 class="text-dark">Petunjuk Penyimpanan</h4>
                    <ol class="text-muted pl-1">
                        <li><i class="fas fa-check"></i> Semangka bisa ditaruh pada suhu kamar selama masih utuh dan belum diiris</li>
                        <li><i class="fas fa-check"></i> Setelah diiris, disimpanlah semangka dalam tempat yang gelap dan dingin</li>
                      </ol>
                </div>
            </div>
        </div>
