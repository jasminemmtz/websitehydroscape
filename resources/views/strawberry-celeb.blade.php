...
<html lang="en">
  <head>
    ...
    <title>Strawberry Celebrations</title>
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-buah/Strawberry Celebrations .webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>

            <div class="col-md-6 product-container">
              <h2 style="font-weight: bold;">Strawberry Celebrations </h2>
              <p class="mb-1">Harga: Rp 61.600,-</p>
              <p class="mb-1">15 - 21 pcs/pack</p>
              <p class="mb-1">Lama Tahannya: 1-2 hari</p>
                ...
                <div class="product-description">
                    ...
                    Strawberry Celebrations merupakan varietas stroberi istimewa yang memukau dengan keunikan rasa manisnya. Buah stroberi ini dipilih secara teliti untuk memberikan kualitas terbaik, menghadirkan sensasi manis yang menggoda lidah. Dengan bentuk yang indah dan warna merah cerah, setiap buahnya menawarkan pengalaman buah segar yang luar biasa. Kesehatan dan kesegaran buah diprioritaskan, menjadikan Strawberry Celebrations pilihan ideal untuk dinikmati langsung, diolah menjadi sajian penutup, atau sebagai tambahan istimewa dalam berbagai kreasi kuliner. Dengan jaminan keamanan dan kualitas, Strawberry Celebrations membawa keceriaan buah segar yang lezat ke meja makan Anda.
                    </p>
                </div>
                <div class="mt-3">
                    <h4 class="text-dark">Petunjuk Penyimpanan</h4>
                    <ol class="text-muted pl-1">
                        <li><i class="fas fa-check"></i> Simpan strawberry dalam kulkas pada suhu sekitar 2-4 derajat Celsius (36-40 derajat Fahrenheit)</li>
                        <li><i class="fas fa-check"></i> Tempatkan strawberry dalam wadah kedap udara atau kantong plastik yang kedap udara</li>
                        <li><i class="fas fa-check"></i> Sebaiknya jangan mencuci strawberry sebelum menyimpannya, karena kelembaban dapat mempercepat pembusukan</li>
                        <li><i class="fas fa-check"></i>  Cuci strawberry hanya saat akan digunakan.</li>
                      </ol>
                </div>
            </div>
        </div>
