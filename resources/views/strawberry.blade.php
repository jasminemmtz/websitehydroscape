...
<html lang="en">
  <head>
    ...
    <title>Strawberry Sweethearts</title>
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-buah/Strawberry Sweethearts.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
                <h2 style="font-weight: bold;">Strawberry Sweethearts</h2>
                <p class="mb-1">Harga: Rp 13.900,-</p>
                <p class="mb-1">13 - 25 pcs/pack</p>
                ...
                <div class="product-description">
                    ...
                    <p class="text-justify">
                        Strawberry Sweethearts khususnya menonjol dengan bentuknya yang unik dan warna merah yang memikat, serta daging buahnya yang juicy dan menyegarkan. Keberagaman penggunaan buah ini juga terlihat, cocok sebagai camilan sehat, bahan selai, bahan dasar smoothies yang lezat, jus, dan berbagai kreasi kuliner lainnya. Dengan menggunakan metode hidroponik, buah-buahan ini telah menciptakan hasil yang menggoda dan berkualitas tinggi.
                    </p>
                </div>
                <div class="mt-3">
                    <h4 class="text-dark">Petunjuk Penyimpanan</h4>
                    <ol class="text-muted pl-1">
                        <li><i class="fas fa-check"></i> Cuci buah strawberry dengan lembut di bawah air mengalir</li>
                        <li><i class="fas fa-check"></i> Untuk menjaga strawberry tetap kering, letakan selembar tisu di bagian bawah wadah sebelum menambahkan strawberry. Hal ini membantu menyerap kelembaban yang mungkin ada</li>
                        <li><i class="fas fa-check"></i> Letakkan strawberry di dalam wadah dengan susunan yang rapi, hindari menumpuk satu sama lain agar tidak rusak atau terhempas</li>
                        <li><i class="fas fa-check"></i> Simpan dalam kulkas atau freezer</li>  
                    </ol>
                </div>
            </div>
        </div>
