...
<html lang="en">
  ...
  <body>
    ...
    <div class="container" style="margin-top: 110px;">
        <div class="row">
            <div class="col-md-6">
                <img src="img/img-buah/Timun.webp" class="img-fluid" alt="Gambar Produk" style="border-radius: 15px;width: 100%;">
            </div>
            <div class="col-md-6 product-container">
                <h2 style="font-weight: bold;">Timun</h2>
                <p class="mb-1">Harga: Rp Rp16.200,-</p>
                <p class="mb-1">6 - 11 pcs/pack</p>
                ...
                <div class="product-description">
                    ...
                    Timun memiliki bentuk yang memanjang berwarna hijau bergradasi dengan warna putih. Daging timun segar dan tinggi kandungan air. Sehingga terasa menyegarkan dan renyah saat dimakan. Timun dapat dikonsumsi langsung sebagai lalapan, sayur, ataupun diolah menjadi es timun segar. Timun ini ditanam secara organik, bebas dari zat kimia tambahan dan pestisida. Sehingga produk yang dihasilkan lebih segar, sehat, dan berkualitas. Terdapat potensi kelebihan/kekurangan gramasi +-10% per pack.
                    </p>
                </div>
                <div class="mt-3">
                    <h4 class="text-dark">Petunjuk Penyimpanan</h4>
                    <ol class="text-muted pl-1">
                        <li><i class="fas fa-check"></i> Tempatkan timun dalam kantong plastik atau wadah berlubang di dalam kulkas Anda</li>
                        <li><i class="fas fa-check"></i>  Lebih baik tidak mencuci timun sebelum disimpan di dalam kulkas</li>
                      </ol>
                </div>
            </div>
        </div>
